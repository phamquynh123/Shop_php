<?php include_once('views/layout/headerCutomer.php') ?>
            ...
            <!-- /.row -->
          	<div style="width:30%; position: absolute; top:90px; right:10px">
                <?php 
                    if(isset($_COOKIE['ok'])){
                 ?>
                ...
                <?php } ?>
                 ...
                 <?php 
                    if(isset($_COOKIE['acceptbuy'])){
                 ?>
                    <div class="alert alert-success">
                  <strong>Success!</strong> XÁC NHẬN ĐẶT HÀNG THÀNH CÔNG!!
                </div>
                <?php } ?>
            </div>
            <div class="row">
          ...
          <div class="row">
            <a href="?mod=sale&act=cart" "email me">email me</a>
          </div>    
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-6">
